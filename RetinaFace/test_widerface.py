...
def parse_args():
    ...
    parser.add_argument('--root-path', help='output data folder', default='/home/lijc08/datasets/widerface/', type=str)
    parser.add_argument('--dataset-path', help='dataset path', default='/home/lijc08/datasets/widerface/', type=str)
    parser.add_argument('--gpu', help='GPU device to test with', default=0, type=int)
    # testing
    parser.add_argument('--prefix', help='model to test with', default='../models/mobilenet_0_25', type=str)
