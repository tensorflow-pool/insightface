...
def parse_args():
    ...
    label_path = os.path.expanduser("~/datasets/cacher/pictures.labels.35/pictures.labels.35.33_34.processed.v22")
    ...
    parser.add_argument('--pretrained', default='./train/models_2019-12-08-00:34:49/model,343490', help='pretrained model to load')
