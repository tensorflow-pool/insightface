...
def parse_args():
    ...
    label_path = os.path.expanduser("/vdb/cacher/pictures.labels.35/left_pictures.labels.35.33_34.processed.v27")
    ...
    parser.add_argument('--pretrained', default='./train/v18_2019-12-19-23:06:25/model,9', help='pretrained model to load')
