...
def parse_args():
    ...
    label_path = os.path.expanduser("~/datasets/cacher/pictures.labels.35/left_pictures.labels.35.33_34.processed.v17")
    ...
    parser.add_argument('--pretrained', default='./train/v17_2019-12-18-10:13:27/model,2', help='pretrained model to load')
