...
def parse_arguments(argv):
    ...
    parser.add_argument('--input', type=str, help='', default=os.path.expanduser('~/datasets/iqiyi/iQIYI-VID-FACE'))
    parser.add_argument('--output', type=str, help='', default=os.path.expanduser('~/datasets/iqiyi/feature'))
    parser.add_argument('--model', type=str, help='', default=os.path.expanduser('../models/model-r34-amf/model,0'))
